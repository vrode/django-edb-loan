...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Loan.purpose'
        db.delete_column('alpha_loan', 'purpose')

        # Adding field 'Loan.location'
        db.add_column('alpha_loan', 'location',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Loan.purpose'
        raise RuntimeError("Cannot reverse this migration. 'Loan.purpose' and its values cannot be restored.")
        # Deleting field 'Loan.location'
        db.delete_column('alpha_loan', 'location')
