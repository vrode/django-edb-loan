...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Loan.timeReturned'
        db.delete_column('alpha_loan', 'timeReturned')

        # Deleting field 'Loan.timeOrdered'
        db.delete_column('alpha_loan', 'timeOrdered')


    def backwards(self, orm):
        # Adding field 'Loan.timeReturned'
        db.add_column('alpha_loan', 'timeReturned',
                      self.gf('django.db.models.fields.DateField')(default=0),
                      keep_default=False)

        # Adding field 'Loan.timeOrdered'
        db.add_column('alpha_loan', 'timeOrdered',
                      self.gf('django.db.models.fields.DateField')(default=0),
                      keep_default=False)
