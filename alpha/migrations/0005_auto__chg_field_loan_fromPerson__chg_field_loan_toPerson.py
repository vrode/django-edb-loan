...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Loan.fromPerson'
        db.alter_column('alpha_loan', 'fromPerson_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Loan.toPerson'
        db.alter_column('alpha_loan', 'toPerson_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Loan.fromPerson'
        db.alter_column('alpha_loan', 'fromPerson_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alpha.Person']))

        # Changing field 'Loan.toPerson'
        db.alter_column('alpha_loan', 'toPerson_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alpha.Person']))
