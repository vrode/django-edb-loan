...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Article', fields ['name']
        db.create_unique('alpha_article', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Article', fields ['name']
        db.delete_unique('alpha_article', ['name'])
